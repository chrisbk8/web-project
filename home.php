   ...
   <body>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-12 left-rs">
                     <div class="navbar-header">
                        ...
                        <a href="index.html" class="navbar-brand">ShoesCredible</a>
                     </div>
                        ...
                        <div class="nav-b hidden-xs">
                           <div class="nav-box">
                              <ul>
                                 ...
                                 <li><a href="about-us.html">ShoesCredible for Business</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
      ...
      <div id="sidebar" class="top-nav">
         <ul id="sidebar-nav" class="sidebar-nav">
            <li><a href="#">Help</a></li>
            <li><a href="howitworks.html">How it works</a></li>
            <li><a href="#">ShoesCredible for Business</a></li>
         </ul>
      </div>
      ...
      <div class="cat-main-box">
         <div class="container">
            <div class="row panel-row">
               <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.0s">
                  <div class="panel panel-default">
                     <div class="panel-body">
                        <img src="images/xpann-icon.jpg" class="icon-small" alt="">
                        <h4>“ShoesCredible” Your Business</h4>
                        <p>Grow easily with ShoesCredible. Create free account.
               ...
               <div class="col-md-6 col-sm-6 wow fadeIn hidden-sm" data-wow-delay="0.4s">
                  <div class="panel panel-default">
                     <div class="panel-body">
            ...
            <div class="row">
               ...
               <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                  <div class="exciting_box l_pd">
                     ...
                     <h4><strong>List your products on</strong> ShoesCredible and grow connections.</h4>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                        quis nostrud exercitation ullamco laboris..
                     </p>
                        ...
                        <div class="col-md-6 col-sm-6">
                           <div class="right-a-f">
                              <p>Over the comming years, way thet business through the web
                                 works will change at agreat - and ShoesCredible is the
                                 gamebreaker.
                              </p>
                           </div>
                        </div>
                     ...
                     <div class="buyer-box clearfix">
                        <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                           <div class="left-buyer">
                              <img class="img-responsive" src="images/nmd.jpg" alt="#" />
                           </div>
                        </div>
                        <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                           <div class="right-buyer">
                              ...
                              <p>Never worry about sales or income ftom outbound
                                 channels. with ShoesCredible your store is directly
      ...
      <!-- <div class="products">
         <div class="main-products">
            <h2>TRENDING PRODUCTS ON ShoesCredible</h2>
                     ...
                     <div class="col-md-6 col-sm-6">
                        <div class="left-f-box">
                           ...
                           <div class="col-sm-4">
                              <h2>COMPANY</h2>
                              <ul>
                                 <li><a href="about-us.html">About ShoesCredible</a></li>
